...
let users  = [
    ...
    new User('12','Olya', 'Catery','345@gmail.com', '+380990839367'),
    new User('4', 'Car','Peten','89@gmail.com', '+380970829251'),
    new User('18', 'Anna', 'Lulu', 'jher@gmail.com', '+3809998543'),
    new User('6', 'Ken', 'Kens', 'ole@,com', '+38099874390'),
    new User('7', 'Cate', 'Sims', 'sims@gmail.com', '+380990493948'),
    new User('81', 'Barbi', 'Barbis', 'barbi@gmail.com', '+3890987437'),
    new User('9', 'Olen','Lusi', 'lusi@gmail.com','+38099584758'),
    new User('101', 'Pitr','Lui', 'fgd@gmail.com', '+3809983757'),
